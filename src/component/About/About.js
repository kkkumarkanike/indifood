        ...
        <div className='main-about'>
          <div className='ramu'>
            ...
            <p>
              ...
              Doloremque cupiditate aspernatur cumque, impedit repudiandae odit
              quam, necessitatibus quia ducimus ipsam excepturi est, nihil illo
              adipisci sapiente amet deserunt a eaque!
            </p>
            <div className='about_socialIcons'>
              ...
              <a href={socialLinks[2]} target='_blank'>
                {' '}
                <FaLinkedinIn />
              </a>
            </div>
          ...
          <div className='kalyan'>
            ...
            <div className='about_socialIcons'>
              <a href={socialLinks[3]} target='_blank'>
                {' '}
                <FaTwitter />
              </a>
              <a href={socialLinks[4]} target='_blank'>
                {' '}
                <FaGithub />
              </a>
              <a href={socialLinks[5]} target='_blank'>
                {' '}
                <FaLinkedinIn />
              </a>
            </div>
